<x-layout>
    ...
    <div class="centered-text">
        ...
        <p>
            These include C, C#, Rust, Java, HTML, CSS, JavaScript, TypeScript, PHP, Python, Node.js, Avalonia, Laravel and Vue.js.
        </p>
        <p>
    ...
    <div class="centered-text">
        ...
        <div class="socials">
            <a href="https://github.com/campos02" target="_blank" class="github button">

<x-layout>
    ...
    <div class="centered-text">
        <h2>Git and contact</h2>
        <div class="socials">
            <a href="https://codeberg.org/campos02" target="_blank" class="black-logo button">
                <img src="images/codeberg-logo_icon_white.svg" srcset="images/codeberg-logo_icon_white.svg"/>
                Codeberg
            </a>
            <a href="https://github.com/campos02" target="_blank" class="black-logo button">
            ...
            <a href="mailto:nonesovile96@hotmail.com" target="_blank" class="email button">
